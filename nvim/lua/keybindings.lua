...
key_mapper('n', '<up>',    '<cmd>resize +2<CR>')
key_mapper('n', '<down>',  '<cmd>resize -2<CR>')
key_mapper('n', '<left>',  '<cmd>vertical resize -2<CR>')
key_mapper('n', '<right>', '<cmd>vertical resize +2<CR>')
key_mapper('n', '<leader>r', '<C-w>r')
